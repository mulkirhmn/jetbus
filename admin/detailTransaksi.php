                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                <?php while ($bangku = mysqli_fetch_assoc($bangku_result)) {
                        ...
                        <?php if ($transaksi['status'] == 'tertunda') { ?>
                            <a href="konfirmasiPembayaran.php?id=<?= $transaksi['id_transaksi']; ?>" class="btn btn-success">Konfirmasi Pembayaran</a>
                        <?php } ?>
                    </div>
                </div>
            </div>
