                ...
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="servicesDropdown">
                            <li><a class="dropdown-item" href="armada.php">Armada</a></li>
                            <li><a class="dropdown-item" href="agen.php">Agen</a></li>
                        </ul>
                    </li>
                    <li class="nav-item">
                        <a class="btn btn-custom ms-3" href="login.php">Login</a>
                    </li>
                </ul>
            </div>
        </div>
